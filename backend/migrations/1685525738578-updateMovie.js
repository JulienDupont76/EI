...
export default class updateMovie1685525738578 {
    name = 'updateMovie1685525738578'
    ...
    async up(queryRunner) {
        ...
        `);
        await queryRunner.query(`
            INSERT INTO "temporary_movie"("id", "title", "overview")
            SELECT "id",
                "title",
                "overview"
            FROM "movie"
    ...
    async down(queryRunner) {
        ...
        `);
        await queryRunner.query(`
            INSERT INTO "movie"("id", "title", "overview")
            SELECT "id",
                "title",
                "overview"
            FROM "temporary_movie"
